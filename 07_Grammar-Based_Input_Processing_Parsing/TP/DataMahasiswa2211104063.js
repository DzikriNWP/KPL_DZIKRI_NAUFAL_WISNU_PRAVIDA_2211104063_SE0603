...
class DataMahasiswa2211104063 {
    ReadJSON() {
        try {
            const rawData = fs.readFileSync('./tp7_1_2211104063.json');
...
// Contoh penggunaan
const dataMahasiswa = new DataMahasiswa2211104063();
dataMahasiswa.ReadJSON();

module.exports = DataMahasiswa2211104063;